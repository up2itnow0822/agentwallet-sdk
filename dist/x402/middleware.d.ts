 ...
 */
export declare function createX402Client(wallet: any, config: any): X402Client;
/**
 ...
 */
export declare function createX402Fetch(wallet: any, config: any): (input: any, init: any) => Promise<Response>;
/**
 ...
 * @param config - Optional x402 client configuration
 */
export declare function wrapWithX402(fetchFn: any, wallet: any, config: any): (input: any, init: any) => Promise<any>;
